...
--- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---:
Button | /components/button | Yes | Yes | Yes | Yes | 4 | 6 | 6 | 877
Icon | /components/icon | Yes | Yes | Yes | Yes | 2 | 3 | 4 | 644
Input | /components/input | Yes | Yes | Yes | Yes | 3 | 3 | 7 | 88
Textarea | /components/textarea | Yes | Yes | Yes | Yes | 3 | 2 | 7 | 103
Form | /components/form | Yes | Yes | Yes | Yes | 4 | 5 | 6 | 170
DescriptionList | /components/description-list | Yes | Yes | Yes | Yes | 4 | 6 | 4 | 88
Collapse | /components/collapse | Yes | Yes | Yes | Yes | 4 | 2 | 5 | 120
Select | /components/select | Yes | Yes | Yes | Yes | 3 | 3 | 7 | 132
Tree | /components/tree | Yes | Yes | Yes | Yes | 3 | 2 | 6 | 124
Transfer | /components/transfer | Yes | Yes | Yes | Yes | 3 | 2 | 6 | 104
Table | /components/table | Yes | Yes | Yes | Yes | 5 | 5 | 8 | 252
Card | /components/card | Yes | Yes | Yes | Yes | 4 | 6 | 6 | 224
...
Tag | /components/tag | Yes | Yes | Yes | Yes | 3 | 6 | 4 | 97
Avatar | /components/avatar | Yes | Yes | Yes | Yes | 3 | 3 | 6 | 133
...
Empty | /components/empty | Yes | Yes | Yes | Yes | 6 | 4 | 3 | 152
