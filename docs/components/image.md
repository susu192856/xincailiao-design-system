...
**适用：** 用于材料图片、证书、图谱和业务媒体内容，使用 1:1、2:1、3:1、3:2、16:9、4:3、3:4 或 2:3 固定比例。

**避免：** 不要按单张原图临时改变列表比例，不要把默认图、加载缓冲和错误态混用，也不要省略 alt 策略。
...
信息图片提供描述性 alt，纯装饰图片使用空 alt；未配置时可暂用默认图，上线前应尽可能替换为真实配图；caption 不重复 alt。
