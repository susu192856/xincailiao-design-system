    ...
    <div className="mt-4 border-t border-zinc-200 pt-3">
      ...
      {usage ? (
        <p className="mt-2 text-xs text-zinc-700">
          <span className="font-semibold text-zinc-900">使用场景：</span>
          {usage}
        </p>
      ) : null}
    </div>
...
function SpecCard({
  ...
  return (
    <div className="bg-white p-6 md:p-7">
      <h3 className="mb-5 text-base font-semibold text-zinc-900">{title}</h3>
      {children}
    </div>
  );
}
  ...
  return (
    <div className="space-y-16">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <SpecCard title="视觉层级（variant）">
            <div className="space-y-3 text-sm text-zinc-700">
              <p>
                <span className="font-semibold text-zinc-900">solid：</span>
                主行动按钮，承载页面或区域内最关键操作。
              </p>
              <p>
                <span className="font-semibold text-zinc-900">outline：</span>
                次要按钮，与主按钮搭配使用，保留操作可见性但降低视觉权重。
              </p>
              <p>
                <span className="font-semibold text-zinc-900">ghost：</span>
                弱按钮，常用于取消、关闭、轻量退出。
              </p>
              <p>
          ...
          <SpecCard title="业务色彩（tone）">
            <div className="space-y-3 text-sm text-zinc-700">
              <p>
                <span className="font-semibold text-zinc-900">neutral：</span>
              ...
              <p>
                <span className="font-semibold text-zinc-900">danger：</span>
      ...
      <section>
        ...
        <div className="mb-8">
          <h3 className="mb-4 text-lg font-semibold text-zinc-900">主要按钮（Solid）</h3>
          <div className="bg-white p-6">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2 xl:grid-cols-3">
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">黑色 - 主行动按钮</p>
                <ButtonStack>
                  <Button>主要操作</Button>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">蓝色 - 产品功能操作</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">红色 - 品牌强调</p>
                <ButtonStack>
        ...
        <div className="mb-8">
          <h3 className="mb-4 text-lg font-semibold text-zinc-900">次要按钮（Outline）</h3>
          <div className="bg-white p-6">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2 xl:grid-cols-3">
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">中性描边</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">产品描边</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">品牌描边</p>
                <ButtonStack>
        ...
        <div className="mb-8">
          <h3 className="mb-4 text-lg font-semibold text-zinc-900">弱按钮（Ghost）</h3>
          <div className="bg-white p-6">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2 xl:grid-cols-3">
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">中性弱按钮（推荐）</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">产品弱按钮</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">品牌弱按钮</p>
                <ButtonStack>
            ...
            <div className="mt-5 bg-amber-50/50 p-4">
              <p className="text-xs leading-6 text-zinc-700">
                <span className="font-semibold text-zinc-900">设计说明：</span>
        ...
        <div className="mb-8">
          <h3 className="mb-4 text-lg font-semibold text-zinc-900">文字按钮（Text）</h3>
          <div className="bg-white p-6">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 text-left md:grid-cols-2 xl:grid-cols-3">
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">中性文字</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">产品文字</p>
                <ButtonStack>
              ...
              <div>
                <p className="mb-3 text-sm font-semibold text-zinc-900">品牌文字</p>
                <ButtonStack>
        ...
        <div>
          <h3 className="mb-4 text-lg font-semibold text-zinc-900">危险按钮（Danger）</h3>
          <div className="bg-white p-6">
            <ButtonGroup>
            ...
            <div className="mt-4 bg-red-50 p-4">
              <p className="text-xs leading-6 text-zinc-700">
                <span className="font-semibold text-zinc-900">颜色规范：</span>
                使用语义色 error (#EF4444)，传达风险和警示，不使用品牌红替代。
              </p>
              <p className="mt-1 text-xs leading-6 text-zinc-700">
                <span className="font-semibold text-zinc-900">使用场景：</span>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-5">
              <div>
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-900">Large - 40px</p>
                  <p className="text-xs text-zinc-600">常规尺寸</p>
                </div>
                <ButtonGroup>
                ...
                <p className="mt-2 text-xs text-zinc-600">内间距: 24px 水平 / 10px 垂直 · 字号: 16px</p>
              </div>

              <div>
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-900">X-Large - 48px</p>
                  <p className="text-xs text-zinc-600">强调尺寸</p>
                </div>
                <ButtonGroup>
                ...
                <p className="mt-2 text-xs text-zinc-600">内间距: 32px 水平 / 12px 垂直 · 字号: 18px</p>
              </div>

              <div>
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-900">2XL - 56px</p>
                  <p className="text-xs text-zinc-600">超大尺寸</p>
                </div>
                <ButtonGroup>
                ...
                <p className="mt-2 text-xs text-zinc-600">内间距: 40px 水平 / 14px 垂直 · 字号: 20px</p>
              </div>
            </div>
            <div className="mt-5 bg-zinc-50 p-4 text-xs leading-6 text-zinc-700">
          ...
          <SpecCard title="后台 / 管理端">
            <div className="space-y-5">
              <div>
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-900">Small - 28px</p>
                  <p className="text-xs text-zinc-600">最小尺寸</p>
                </div>
                <ButtonGroup>
                ...
                <p className="mt-2 text-xs text-zinc-600">高度: 28px · 字号: 14px · 用于表格行内、紧凑工具栏</p>
              </div>

              <div>
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-900">Medium - 32px</p>
                  <p className="text-xs text-zinc-600">标准尺寸（推荐）</p>
                </div>
                <ButtonGroup>
                ...
                <p className="mt-2 text-xs text-zinc-600">高度: 32px · 字号: 14px · 用于表单、筛选、常规提交</p>
              </div>

              <div>
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-sm font-semibold text-zinc-900">Large - 36px</p>
                  <p className="text-xs text-zinc-600">最大尺寸</p>
                </div>
                <ButtonGroup>
                ...
                <p className="mt-2 text-xs text-zinc-600">高度: 36px · 字号: 14px · 用于弹窗主操作、页面级关键操作</p>
              </div>
            </div>
            <div className="mt-5 bg-zinc-50 p-4 text-xs leading-6 text-zinc-700">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2">
          <SpecCard title="水平排列">
            <div className="space-y-6">
              <div>
                <p className="mb-2 text-xs text-zinc-600">间距 12px (gap-3) - 推荐</p>
              ...
              <div>
                <p className="mb-2 text-xs text-zinc-600">间距 8px (gap-2) - 紧凑场景</p>
              ...
              <div>
                <p className="mb-2 text-xs text-zinc-600">间距 16px (gap-4) - 官网场景</p>
          ...
          <SpecCard title="垂直排列（移动端）">
            <div className="space-y-6">
              <div>
                <p className="mb-2 text-xs text-zinc-600">间距 12px (space-y-3)</p>
              ...
              <div>
                <p className="mb-2 text-xs text-zinc-600">间距 8px (space-y-2)</p>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2">
          <SpecCard title="图标位置">
            <div className="space-y-6">
              <div>
                <p className="mb-2 text-xs text-zinc-600">图标前置 - 标准操作</p>
                <ButtonGroup>
              ...
              <div>
                <p className="mb-2 text-xs text-zinc-600">图标后置 - 表示方向或延伸</p>
                <ButtonGroup>
                  <Button tone="brand" icon={<ArrowRight className="h-4 w-4" weight="regular" />} iconPosition="right">
                    查看详情
                  </Button>
              ...
              <div>
                <p className="mb-2 text-xs text-zinc-600">纯图标按钮 - 工具栏 / 表格操作</p>
          ...
          <SpecCard title="图标尺寸规范">
            <div className="space-y-4">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-xs text-zinc-600">14px 图标</span>
              </div>
              <div className="flex flex-wrap items-center gap-3">
                <Button tone="product" icon={<Plus className="h-4 w-4" weight="regular" />}>
                  Medium
                </Button>
                <span className="text-xs text-zinc-600">16px 图标（推荐）</span>
              </div>
              <div className="flex flex-wrap items-center gap-3">
                <Button size="lg" tone="product" icon={<Plus className="h-5 w-5" weight="regular" />}>
                  Large
                </Button>
                <span className="text-xs text-zinc-600">20px 图标</span>
              </div>
            </div>

            <div className="mt-5 bg-amber-50/50 p-4">
              <p className="text-xs leading-6 text-zinc-700">
                <span className="font-semibold text-zinc-900">图标间距：</span>
                图标与文字间距为 8px (gap-2)，保持视觉平衡。
              </p>
              <p className="mt-1 text-xs leading-6 text-zinc-700">
                <span className="font-semibold text-zinc-900">纯图标按钮：</span>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <SpecCard title="推荐做法">
            <DotList
              items={[
                "<span class='font-semibold text-zinc-900'>单一主按钮：</span>每个页面或区域只应有一个主按钮，突出最重要的操作。",
                "<span class='font-semibold text-zinc-900'>清晰文案：</span>使用动词开头的简洁文案，如“提交订单”“新建数据”。",
                "<span class='font-semibold text-zinc-900'>语义分离：</span>variant 表示层级，tone 表示业务色彩，避免把蓝色称为次按钮。",
                "<span class='font-semibold text-zinc-900'>按钮顺序：</span>取消/关闭等退出操作放左侧，确定/保存等主操作放右侧。",
                "<span class='font-semibold text-zinc-900'>颜色选择：</span>黑色用于主行动，产品蓝用于功能操作，品牌红用于官网关键转化。",
                "<span class='font-semibold text-zinc-900'>多端适配：</span>官网使用大尺寸增强转化，后台使用小尺寸提升效率。",
              ]}
            />
          </SpecCard>
          ...
          <SpecCard title="避免做法">
            <DotList
              tone="danger"
              items={[
                "<span class='font-semibold text-zinc-900'>多个主按钮：</span>避免在同一区域放置多个 solid 按钮造成选择困难。",
                "<span class='font-semibold text-zinc-900'>颜色混用：</span>避免在同一组按钮中混用黑色、蓝色、红色主按钮。",
                "<span class='font-semibold text-zinc-900'>语义误用：</span>不要将 product 蓝直接命名为 secondary。",
                "<span class='font-semibold text-zinc-900'>过长文案：</span>避免按钮文字超过 4-6 个字，保持简洁。",
                "<span class='font-semibold text-zinc-900'>尺寸混用：</span>官网和后台应分别使用对应尺寸规范。",
                "<span class='font-semibold text-zinc-900'>纯图标无说明：</span>纯图标按钮必须提供 tooltip 或 aria-label。",
              ]}
            />
          </SpecCard>
        </div>

        <div className="mt-6 bg-zinc-50 p-6">
          <h3 className="mb-4 text-base font-semibold text-zinc-900">多端应用场景参考</h3>
          <div className="grid grid-cols-1 gap-5 text-sm md:grid-cols-3">
            <div className="bg-white p-4">
              <p className="mb-2 font-semibold text-zinc-900">官网营销页</p>
            ...
            <div className="bg-white p-4">
              <p className="mb-2 font-semibold text-zinc-900">数据空间 / 材库 / AI 应用</p>
              <ul className="space-y-1 text-zinc-700">
            ...
            <div className="bg-white p-4">
              <p className="mb-2 font-semibold text-zinc-900">移动端应用</p>
              <ul className="space-y-1 text-zinc-700">
