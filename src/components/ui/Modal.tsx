        ...
        <div className="flex items-start justify-between gap-4 border-b border-[var(--neutral-200)] p-5">
          ...
          {closeable ? (
            <button
              ...
              onClick={onClose}
              aria-label="关闭"
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[var(--radius-sm)] text-[var(--neutral-600)] hover:bg-[var(--neutral-100)] hover:text-[var(--neutral-900)]"
            >
              <X className="h-4 w-4" />
            </button>
          ) : null}
