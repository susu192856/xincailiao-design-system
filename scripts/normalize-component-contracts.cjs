...
const componentRules = {
  ...
  Radio: {
    ...
    content: "选项文案保持同一语法结构，高风险选项直接说明影响与限制；选中使用产品蓝，默认与禁用使用中性灰，品牌红不进入常规选择控件。",
  },
  Checkbox: {
    ...
    content: "选择项使用可独立理解的短句；协议文案说明责任和操作后果；选中与半选使用产品蓝，默认与禁用使用中性灰，品牌红不进入常规选择控件。",
  },
  Switch: {
    ...
    content: "标签描述设置本身，状态文案使用已开启/已关闭或具体业务结果；开启使用产品蓝，关闭与禁用使用中性灰，品牌红不进入常规开关。",
  },
  Pagination: {
